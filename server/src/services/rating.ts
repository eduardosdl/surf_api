...
export class Rating {
  constructor(private beach: BeachProps) {}
  ...
  public getRateForPoint(point: ForecastPoint): number {
    ...
    const swellHeightRating = this.getRatingForSellSize(point.swellHeight);
  ...
  public getRatingForSellSize(height: number): number {
    if (
