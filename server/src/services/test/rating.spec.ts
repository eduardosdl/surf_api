import { GeoPosition, BeachProps } from '@src/models/beach';
...
describe('Rating service', () => {
  ...
  describe('Calculate rating for a given point', () => {
    ...
    it('should get a rating less then 1 for a poor point', () => {
    ...
    it('should get a rating 4 for a point with offshore winds, halt overhead high swell and good interval', () => {
      const point = {
        ...defaultPoint,
        ...{
          swellHeight: 0.7,
    ...
    it('should get a rating 4 for a point with offshore winds, shoulder high swell and good interval', () => {
      const point = {
        ...defaultPoint,
        ...{
          swellHeight: 1.5,
    ...
    it('should get a rating 4 a good condition but with crosshore winds', () => {
      const point = {
        ...defaultPoint,
        ...{
          swellHeight: 2.5,
    ...
    it('should get a rating 5 classic day', () => {
      const point = {
        ...defaultPoint,
        ...{
          swellHeight: 2.5,
  ...
  describe('Get rating based on swell heigth', () => {
    it('should get rating 1 for less then ankle to knee high swell', () => {
      const rating = defaultRating.getRatingForSellSize(0.2);
      expect(rating).toBe(1);
    });

    it('should get rating 2 for an ankle to knee high swell', () => {
      const rating = defaultRating.getRatingForSellSize(0.6);
      expect(rating).toBe(2);
    });

    it('should get rating 3 for waist high swell', () => {
      const rating = defaultRating.getRatingForSellSize(1.5);
      expect(rating).toBe(3);
    });

    it('should get rating 5 for overhead swell', () => {
      const rating = defaultRating.getRatingForSellSize(2.5);
      expect(rating).toBe(5);
    });
  });
